...
lowpass = ones(5)./25; % Creates a 5x5 matrix of values 1/25 
...
level = graythresh(bfilt); %Otsu algorithm
...
nofr = sum(n==1);% The number of rows of the bricks (the seond output argument of this function)
nofr = nofr-1; % Subtract with 1 since there is an extra "line" from the thresholding
